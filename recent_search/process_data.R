...
load("recent_search/raw_dataset.RData")
...
# this is how many response objects you've reecived from the API
length(raw_content)
...
# some functions are already included in f_aux_functions.R -> check the examples
...
save(df_tweets, df_users, df_ref_tweets, df_places, file = "recent_search/processed_data.RData")
