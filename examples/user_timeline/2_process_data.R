...
# aux_functions.R contains functions for data processing
source(here::here("aux_functions.R"))

# load the dataset you've just collected
load(here::here("examples", "user_timeline", "raw_dataset.RData"))
...
save(df_tweets,  
     file = here::here("examples", "user_timeline", "processed_data.RData"))
