...
Let this Section we included from a separate `.Rmd` file called `section_1.Rmd`. In this repository (`DFCP_public`), the file is available in `.\examples\how_to_Rmd\sections`.
...
```{r, child=here::here("examples", "how_to_Rmd", "sections", "section_3.Rmd")}
```
